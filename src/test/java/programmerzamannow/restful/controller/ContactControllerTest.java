...
class ContactControllerTest {
    ...
    @Test
    void searchDataNotFound() throws Exception {
        mockMvc.perform(
                get("/api/contacts")
                        .contentType(MediaType.APPLICATION_JSON)
                        .header("X-API-TOKEN", "test")
    ...
    @Test
    void searchSuccesess() throws Exception {
        User user = userRepository.findById("test").orElseThrow();
        ...
        for (int i = 0; i < 100; i++) {
            Contact contact = new Contact();
            contact.setId(UUID.randomUUID().toString());
            contact.setFirstName("Kennedy"+i);
            contact.setLastName("Bambang");
            contact.setUser(user);
            contact.setPhone("08080808");
            contact.setEmail("reza@gmail.com");
            contactRepository.save(contact);
        }
        ...
        for (int i = 0; i < 100; i++) {
            ...
            contact.setLastName("Bambang");
            contact.setUser(user);
            contact.setPhone("081270");
            contact.setEmail("gogo@gmail.com");
            contactRepository.save(contact);
        }
        ...
        mockMvc.perform(
                get("/api/contacts")
                        .queryParam("email","reza@gmail.com")
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
                        .header("X-API-TOKEN", "test")
        ).andExpectAll(
